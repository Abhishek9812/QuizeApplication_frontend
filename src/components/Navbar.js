...
const Navbar = (props) => {
    ...
    return (<>
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <NavLink className="navbar-brand" style={{ marginLeft: "50px" }} to="/">Quize Admin</NavLink>
                ...
                <ul className="navbar-nav mr-auto">
                    {userData ?
                        <>
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link" to="/createQuize">Create Quize </NavLink>
                            </li>   
                            <li className="nav-item">
                                <NavLink className="nav-link" to="/createQuestion">Create Question </NavLink>
                            </li>   
                            <li className="nav-item">
